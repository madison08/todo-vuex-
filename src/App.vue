...
.input_todos_bloc input::placeholder{
  color: #a19c9c;
  font-style: italic;
}
.input_todos_bloc button{
  border: none;
  font-size: 25px;
  padding: 10px;
  margin-right: 10px;
